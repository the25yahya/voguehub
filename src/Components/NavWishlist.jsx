...
const NavWishlist = () => {
  ...
  return (
    <div  className={`absolute z-50 w-full ${navWishlist ? 'grid place-items-center' : 'hidden'}`}>
        <div className='flex flex-col items-center'>
          <div className='bg-black text-white flex items-center justify-between w-full p-2 px-5'>
            ...
            <p onClick={CloseWishlist}><IoMdClose /></p>
          </div>
          <div className='flex flex-col justify-between bg-white p-5'>
            ...
            <div className='w-full flex items-center justify-between'>
                <p className='underline text-sm mr-10'>OPEN WISHLIST PAGE</p>
                <p className='underline text-sm'>CONTINUE SHOPPING</p>
            </div>
          </div>
       </div>
    </div>
