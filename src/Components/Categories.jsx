    ...
    <div className='flex items-center mt-50 justify-center flex-wrap'>
        <div className='relative mx-2 mb-4'>
          ...
          <div className='absolute bottom-5 left-6'>
           ...
           <Link to='/Men' ><button  className='bg-white px-4 py-1 hover:bg-transparent transition cursor-pointer hover:text-white'>SHOP NOW</button></Link>
          </div>
        </div>
        <div className='relative mx-2 mb-4'>
          ...
          <div className='absolute bottom-5 left-5'>
           ...
           <Link to='/Women'><button  className='bg-white px-4 py-1 hover:bg-transparent transition cursor-pointer hover:text-white'>SHOP NOW</button></Link>
          </div>
        </div>
        <div className='relative mx-2 mb-4'>
          ...
          <div className='absolute bottom-5 left-5'>
           ...
           <Link to='/Kids'><button className='bg-white px-4 py-1 hover:bg-transparent transition cursor-pointer hover:text-white'>SHOP NOW</button></Link>
          </div>
        </div>
    </div>
  )
