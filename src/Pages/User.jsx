          ...
          <div className='mt-28'>
            ...
            <div className='p-10 mt-5'>
              ...
              <div className='flex flex-col mb-4'>
                <label className='text-sm font-semibold' htmlFor="myInput">Username or email address</label>
              ...
              <div className='flex flex-col'>
                ...
                <input className='border-2 border-black w-500 py-2' type="password" name="myInput2"></input>
              </div>
