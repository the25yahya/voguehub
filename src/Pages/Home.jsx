...
const Home = () => {
  ...
  return (
    <div className={navCart ? 'brightness-50 transition' : ''}>
      ...
      <section className='z-20 text-white  w-full flex flex-col text-center items-center pb-10 hero mt-100 relative slide-left fade-in'>
        ...
        <div onClick={setImg2} className='absolute text-white top-1/2 text-6xl z-30 opacity-25 right-5 cursor-pointer'><GoChevronRight/></div>
        <div onClick={setImg1} className='absolute text-white top-1/2 text-6xl z-30 opacity-25 left-5 cursor-pointer'><GoChevronLeft/></div>
       </section>
      </div>
